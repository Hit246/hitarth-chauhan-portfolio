...
const ProjectCard: React.FC<{ project: Project; index: number }> = ({ project, index }) => {
  return (
    ...
    >
      <div className="relative w-full h-full duration-500 transition-all transform-style-3d group-hover:rotate-y-180 preserve-3d">
        {/* Front */}
        <div className="absolute inset-0 backface-hidden rounded-2xl overflow-hidden bg-white/5 border border-white/10 shadow-xl">
        ...
        {/* Back */}
        <div className="absolute inset-0 backface-hidden rotate-y-180 rounded-2xl overflow-hidden bg-dark border border-primary/30 shadow-2xl p-8 flex flex-col justify-center items-center text-center bg-[url('https://www.transparenttextures.com/patterns/cubes.png')]">
